...
const ShoppingList = () => {
  ...
  const watchesItems = items.filter(
    (item) => item.attributes.category === "watches"
  );
  const shoesItems = items.filter(
    (item) => item.attributes.category === "shoes"
  );
  const electronicsItems = items.filter(
    (item) => item.attributes.category === "electronics"
  );
